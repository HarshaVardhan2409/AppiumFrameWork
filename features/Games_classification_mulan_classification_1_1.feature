...
Scenario: check the text of question 1 on the screen testrail details_1589_29
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Header_question&Passive_1Common_Stage | Stage_1 |
...
Scenario: check whether buckets are accepting the valid draggables for question 2 testrail details_1590_29
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Header_question&Passive_1Common_Stage | Stage_1 |
...
Scenario: check whether buckets are accepting the invalid draggables for question 2 testrail details_1591_29
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Header_question&Passive_1Common_Stage | Stage_1 |
...
Scenario: check the text of question 2 on the screen testrail details_1594_29
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Header_question&Passive_1Common_Stage | Stage_1 |
...
Scenario: check whether buckets are accepting the valid draggables for question 3 testrail details_1595_29
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Header_question&Passive_1Common_Stage | Stage_1 |
...
Scenario: check whether buckets are accepting the invalid draggables for question 3 testrail details_1596_29
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Header_question&Passive_1Common_Stage | Stage_1 |
...
Scenario: check the text of question 3 on the screen testrail details_1599_29
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Header_question&Passive_1Common_Stage | Stage_1 |
...
Scenario: check whether user can able to complete the game by drag and drop the valid draggables testrail details_1600_29
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Header_question&Passive_1Common_Stage | Stage_1 |
