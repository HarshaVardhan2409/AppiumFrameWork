...
def start_execution(feature_file=None):
    ...
    if feature_file == None:
        subprocess.Popen(
            'behave -D APP_PATH=C:\\Users\\Vinayaka\\Downloads\\k3_new_11.apk -D DEVICE_TYPE=android -D MACHINE_TYPE=windows -D TESTRAIL_USER=archana.r@testyantra.com -D TESTRAIL_PASS=Pass1234',
            shell=False)
    else:
        subprocess.Popen(
            'behave -D APP_PATH=C:\\Users\\Vinayaka\\Downloads\\k3_new_11.apk -D DEVICE_TYPE=android -D MACHINE_TYPE=windows -D TESTRAIL_USER=archana.r@testyantra.com -D TESTRAIL_PASS=Pass1234 '+feature_file,
            shell=False)
...
'''    
start_execution('Quest_flow.feature')
