...
Then update the result to testrail: case 1506 : suite 30

Scenario: check whether buckets are accepting the invalid draggables for question 1
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Question&Passive_1Stage_1 | Stage_1 |
...
Then update the result to testrail: case 1507 : suite 30

Scenario: check the animation of buckets by drag and drop the valid draggables for question 1
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Question&Passive_1Stage_1 | Stage_1 |
...
| Pounds&DraggableObject_2Stage_1 | Bucket_Pounds&Bucket_2Stage_1 | true |
| Stone&DraggableObject_1Stage_1 | Bucket_Stone&Bucket_3Stage_1 | true |
Then update the result to testrail: case 1508 : suite 30

Scenario: check the animation of buckets by drag and drop the invalid draggables for question 1
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Question&Passive_1Stage_1 | Stage_1 |
...
| Pounds&DraggableObject_2Stage_1 | Bucket_Stone&Bucket_3Stage_1 | false |
| Ounces&DraggableObject_3Stage_1 | Bucket_Stone&Bucket_3Stage_1 | false |
Then update the result to testrail: case 1509 : suite 30
...
Then update the result to testrail: case 1510 : suite 30
...
| Pounds&DraggableObject_2Stage_1 | Bucket_Pounds&Bucket_2Stage_1 | true |
| Stone&DraggableObject_1Stage_1 | Bucket_Stone&Bucket_3Stage_1 | true |
Then update the result to testrail: case 1511 : suite 30

Scenario: check whether buckets are accepting the valid draggables for question 2
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Question&Passive_1Stage_1 | Stage_1 |
...
Then update the result to testrail: case 1512 : suite 30

Scenario: check whether buckets are accepting the invalid draggables for question 2
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Question&Passive_1Stage_1 | Stage_1 |
...
Then update the result to testrail: case 1513 : suite 30

Scenario: check the animation of buckets by drag and drop the valid draggables for question 2
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Question&Passive_1Stage_1 | Stage_1 |
...
| Hawk&DraggableObject_3Stage_2 | Bucket_Hawk&Bucket_3Stage_2 | true |
| Chick&DraggableObject_2Stage_2 | Bucket_Chickl&Bucket_4Stage_2 | true |
Then update the result to testrail: case 1514 : suite 30

Scenario: check the animation of buckets by drag and drop the invalid draggables for question 2
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Question&Passive_1Stage_1 | Stage_1 |
...
| Hawk&DraggableObject_3Stage_2 | Bucket_Chickl&Bucket_4Stage_2 | false |
| Horse&DraggableObject_4Stage_2 | Bucket_Chickl&Bucket_4Stage_2 | false |
Then update the result to testrail: case 1515 : suite 30
...
Then update the result to testrail: case 1516 : suite 30
...
| Hawk&DraggableObject_3Stage_2 | Bucket_Hawk&Bucket_3Stage_2 | true |
| Chick&DraggableObject_2Stage_2 | Bucket_Chickl&Bucket_4Stage_2 | true |
Then update the result to testrail: case 1517 : suite 30

Scenario: check whether user can able to complete the game by drag and drop the valid draggables
Given start scene is loaded
And question is loaded:
| object_with_question | question_number |
| Question&Passive_1Stage_1 | Stage_1 |
...
| Hawk&DraggableObject_3Stage_2 | Bucket_Hawk&Bucket_3Stage_2 | true |
| Chick&DraggableObject_2Stage_2 | Bucket_Chickl&Bucket_4Stage_2 | true |
Then update the result to testrail: case 1518 : suite 30